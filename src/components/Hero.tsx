...
export function Hero() {
  ...
  const handlePhoneClick = () => {
    ...
    // Create a custom modal for three options
    const createPhoneModal = () => {
      ...
      modal.innerHTML = `
        <div class="bg-background border border-border rounded-lg p-6 max-w-sm mx-4 shadow-xl">
          <h3 class="text-lg font-medium mb-4 text-center">Contact Options</h3>
          <p class="text-sm text-muted-foreground mb-6 text-center">How would you like to contact me?</p>
          <div class="space-y-3">
            <button id="call-btn" class="w-full p-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg flex items-center justify-center gap-2 transition-colors">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
              </svg>
              Call Me
            </button>
            <button id="whatsapp-btn" class="w-full p-3 bg-green-500 hover:bg-green-600 text-white rounded-lg flex items-center justify-center gap-2 transition-colors">
            ...
            <button id="cancel-btn" class="w-full p-3 bg-gray-500 hover:bg-gray-600 text-white rounded-lg flex items-center justify-center gap-2 transition-colors">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
